...
export type { CommandResult, PackageEntry, SearchResult, ListFormatOptions, InstallOptions, } from './cli/types.js';
 ...
 * ```
 */
export declare function createNpm(config?: NpmConfig): NpmSDK;
/**
 ...
 * ```
 */
export declare function npx(command: string, args?: string[], options?: NpmConfig): Promise<{
    exitCode: number;
    output: string;
}>;
/**
 ...
 * ```
 */
export declare const npm: NpmSDK;
