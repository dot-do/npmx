 ...
 */
import { TAR_BLOCK_SIZE, TYPE_FLAGS, } from './types';
 ...
 */
export function parseTarHeader(header) {
 ...
 */
function validateChecksum(header, expectedChecksum) {
 ...
 */
export function parsePaxHeaders(content) {
 ...
 */
export function createPaxHeader(headers) {
    let content = '';
 ...
 */
export function createTarHeader(name, size, options = {}) {
    const header = new Uint8Array(TAR_BLOCK_SIZE);
    const { mode = 0o644, uid = 0, gid = 0, mtime = new Date(), type = 'file', linkname = '', uname = '', gname = '', prefix = '', } = options;
    // Name (0-99)
 ...
 */
function writeString(header, offset, str, length) {
 ...
 */
function writeOctal(header, offset, value, length) {
 ...
 */
export function padToBlockSize(data) {
 ...
 */
export function createEndOfArchive() {
