 ...
 */
export function compareBuild(v1, v2, options) {
 ...
 */
export function major(version, options) {
 ...
 */
export function minor(version, options) {
    const v = version instanceof SemVer ? version : new SemVer(version, options);
    return v.minor;
}
/**
 ...
 */
export function patch(version, options) {
    const v = version instanceof SemVer ? version : new SemVer(version, options);
    return v.patch;
}
/**
