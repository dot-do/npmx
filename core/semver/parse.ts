 ...
 */
function parseBuild(build: string | undefined): BuildIdentifier[] {
  if (!build) return []
  return build.split('.')
}
...
export class SemVer implements SemVerObject {
  ...
  constructor(
    version: string | SemVer | SemVerObject,
 ...
 */
function compareVersions(a: SemVerObject, b: SemVerObject): -1 | 0 | 1 {
