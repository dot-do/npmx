 ...
 * @module npmx/types
 */
export type { NpmSecurityConfig, SecurityCheckResult, SecurityViolation, VulnerabilitySeverity, } from './core/security/policy.js';
/**
 ...
 */
export declare function createEmptyInstallResult(): InstallResult;
